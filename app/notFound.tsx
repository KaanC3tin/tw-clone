                ...
                <div className="text-white items-center flex h-screen">
                        ...
                        <div className="flex flex-col items-center">
                            <Link href="/home">
                                <div className="hover:bg-twitterIConHover rounded-full w-14 h-14 flex items-center justify-center duration-1000 ml-[-18px] xl:ml-[-18px] lg:ml-[-18px] md:ml-[-18px] sm:ml-[-18px] xs:ml-[-18px] 2xs:ml-[-18px]">
                                    <Icon icon="prime:twitter" width={31} height={31} />
                                </div>
                            </Link>
                        </div>
                                ...
                                {mainMenu.map((menu, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <span
                                                className={`text-xl hidden xl:block ${isActive ? "font-bold" : ""
                                                    }`}
                                            >
                                                {menu.title}
                                            </span>
                    ...
                    <div className="w-[900px] border-twitterBorder border-x h-screen flex items-center justify-center">
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <Link href="/explore">
                                <button className="mt-[-630px] bg-[#1d9bf0] text-[15px] text-white">
                                    Search
                                </button>
                            </Link>
                            <SignOutButton />
