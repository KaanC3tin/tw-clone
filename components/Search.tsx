    ...
    <div className='fixed top-0 pt-[6px] bg-black  z-50'>
      <Popover>
        ...
        >
          ...
          {/* <div className='h-[42px] w-[350px] bg-[#202327] rounded-full px-5 flex items-center border border-transparent focus-within:border-[#1d9bf0]  focus-within:bg-black group '> */}
