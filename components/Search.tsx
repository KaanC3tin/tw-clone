    ...
    <div>
      <Popover>
        ...
        >
          ...
          <label className='flex mr-12 text-[#71767B] '>
            ...
            <div className='ml-5 font-normal text-[15px]'>
              <input type="text" className='bg-transparent w-full h-full  border-0  focus:border-none outline-none placeholder:text-[#71767B]'
                placeholder='Search' />
        ...
        <PopoverPanel className="bg-black shadow-box flex justify-center pt-[20px] h-[105px] bottom-0 rounded-xl -z-10 text-[#71767B] font-normal text-[15px]">
          <span>Tyr searching for people,lists, or keyboyrds</span>
        </PopoverPanel>
      </Popover>
    </div>
  )
